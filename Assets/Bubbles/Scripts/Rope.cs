...
public class Rope : MonoBehaviour
{
    ...
    //Rope data
    private float ropeSectionLength = 0.1f;
    ...
    {
        whatIsHangingFromTheRope.GetComponent<Rigidbody>().AddForce(Vector3.left * Time.fixedDeltaTime, ForceMode.Acceleration);
        UpdateRopeSimulation();
    }

    private void UpdateRopeSimulation()
    {
        Vector3 gravityVec = new Vector3(0f, -0.81f, 0f);
